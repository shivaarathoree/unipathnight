...
export default function CareerRoadmapPage() {
  ...
  if (generating) {
    return (
      <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center pt-24 pb-8 px-8">
        <div className="text-center max-w-md">
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
          >
            <Sparkles className="w-20 h-20 text-[#FF6B6B] mx-auto mb-6" />
          </motion.div>
          ...
          <div className="flex items-center justify-center gap-2">
            {[0, 1, 2].map((i) => (
              <motion.div
                key={i}
                className="w-3 h-3 bg-gradient-to-r from-[#FF6B6B] to-[#FFE5E5] rounded-full"
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white pt-24 pb-8 px-4 md:px-8">
...
function QuestionCard({ question, onAnswer, selectedAnswer }) {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-2xl p-8 md:p-12 border border-white/20"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {question.options.map((option, index) => (
          <motion.button
            ...
            className="group relative p-6 bg-[#0A0A0A] border-2 border-white/30 rounded-xl text-left hover:border-white hover:bg-white/5 transition-all duration-300"
